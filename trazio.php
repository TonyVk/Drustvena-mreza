...
<ul>
  <?php
	...
	if(isset($_SESSION['login_user']))
	{
		...
		echo "<form action='trazio.php' method='POST'><div id='trazi'><li style='float:right'><a class='active'><img src='slike/search.png'></a></li></div>";
...
<?php
	$id=$_SESSION['ID'];
	$rezultat = mysqli_query($conn,"SELECT * FROM racuni WHERE Ime LIKE '%$_POST[trazi]%' OR Prezime LIKE '%$_POST[trazi]%' order by ID desc;");
	while($redaka = mysqli_fetch_array($rezultat))
	{
